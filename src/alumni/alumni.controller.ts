...
export class AlumniController {
  ...
  async Login(
    ...
    return res.status(HttpStatus.CREATED).json({ status: "success", message: 'login successfully', Email: alumni.Email, uuid: alumni.uuid, Name: `${alumni.FirstName} ${alumni.LastName}` });
  }
